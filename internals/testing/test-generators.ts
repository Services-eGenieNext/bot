...
const componentsPath = path.join(process.cwd(), '../../src/builder/components');
const containersPath = path.join(process.cwd(), '../../src/builder/containers');
const rootStatePath = path.join(process.cwd(), '../../src/shared/types/RootState.ts');
